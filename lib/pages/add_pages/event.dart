...
class _EventsAddPageState extends State<EventsAddPage> {
  ...
  Widget _buildDescriptionTextField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
          ...
          hintText: 'Tell  users more about the event',
  ...
  Widget _buildPriceTextField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
          labelText: "Price*",
          hintText: ' If the event is free, type 0',
          prefixText: '\₵',
          suffixText: 'GH₵',
      ...
      builder: (BuildContext context, Widget child, MainModel model) {
        return model.isLoading
            ...
            : RaisedButton(
                ...
                onPressed: () {
                  _submitForm(model.addEvent, model.selectItem,
                      model.selectedEventsIndex);
  ...
  Widget _buildPageContent(BuildContext context, Item events) {
  ...
  void _submitForm(Function addEvent, Function setSelectedEvent,
  ...
  Widget build(BuildContext context) {
    return ScopedModelDescendant<MainModel>(
      builder: (BuildContext context, Widget child, MainModel model) {
        return _buildPageContent(context, model.selectedEvent);
      },
    );
  }
}

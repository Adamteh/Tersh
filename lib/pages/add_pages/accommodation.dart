...
class AccommodationAddPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _AccommodationAddPageState();
  }
}

class _AccommodationAddPageState extends State<AccommodationAddPage> {
  ...
  Widget _buildDescriptionTextField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
          ...
          hintText: 'Tell  users more about the hostel/appartment',
  ...
  Widget _buildLocationAddressTextField() {
    return TextFormField(
      decoration: InputDecoration(
          labelText: "Address*",
          hintText: 'Location of the hostel/appartment',
          border: OutlineInputBorder(borderRadius: BorderRadius.circular(20))),
      validator: (String value) {
        if (value.trim() == '' || value.isEmpty || value.length < 3) {
      ...
      builder: (BuildContext context, Widget child, MainModel model) {
        return model.isLoading
            ...
            : RaisedButton(
                ...
                onPressed: () {
                  _submitForm(model.addAccommodation, model.selectItem,
                      model.selectedAccommodationIndex);
  ...
  Widget _buildPageContent(BuildContext context, Item accommodation) {
                ...
                child: Row(
                  children: <Widget>[
                    Container(
                      child: Stack(
                        children: <Widget>[
                          ImageInput(_setImage, accommodation),
                          Text('1*'),
                        ],
                      ),
                    ),
                    ...
                    Container(
                      child: Stack(
                        children: <Widget>[
                          ImageInput(_setImage1, accommodation),
                          Text('2'),
                        ],
                      ),
                    ),
                    ...
                    Container(
                      child: Stack(
                        children: <Widget>[
                          ImageInput(_setImage2, accommodation),
                          Text('3'),
                        ],
                      ),
                    ),
                    ...
                    Container(
                      child: Stack(
                        children: <Widget>[
                          ImageInput(_setImage3, accommodation),
                          Text('4'),
                        ],
                      ),
                    ),
                    ...
                    Container(
                      child: Stack(
                        children: <Widget>[
                          ImageInput(_setImage4, accommodation),
                          Text('5'),
                        ],
                      ),
                    ),
  ...
  void _submitForm(Function addAccommodation, Function setSelectedAccommodation,
    ...
    addAccommodation(
      ...
      (bool success) {
        ...
        if (success) {
          ...
          ).then((_) => setSelectedAccommodation(null));
        } else {
  ...
  Widget build(BuildContext context) {
    return ScopedModelDescendant<MainModel>(
      builder: (BuildContext context, Widget child, MainModel model) {
        return _buildPageContent(context, model.selectedAccommodation);
      },
    );
  }
}

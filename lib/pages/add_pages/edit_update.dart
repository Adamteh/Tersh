...
import '../../widgets/form_inputs/image_update.dart';
import '../../main.dart';
...
class _EditState extends State<Edit> {
  ...
  Widget _buildTitleTextField(Item item) {
  ...
  Widget _buildDescriptionTextField(Item item) {
    return TextFormField(
      maxLines: 4,
      decoration: InputDecoration(
  ...
  Widget _buildPriceTextField(Item item) {
    return TextFormField(
  ...
  Widget _buildLocationAddressTextField(Item item) {
    return TextFormField(
      decoration: InputDecoration(
          labelText: "Address*",
          border: OutlineInputBorder(borderRadius: BorderRadius.circular(20))),
      initialValue: item.locationAddress,
      validator: (String value) {
        if (value.trim() == '' || value.isEmpty || value.length < 3) {
  ...
  Widget _buildSubmitButton() {
    return ScopedModelDescendant<MainModel>(
      builder: (BuildContext context, Widget child, MainModel model) {
        ...
        var selectedItemsIndex = allItems.indexWhere((Item item) {
    ...
    return GestureDetector(
      ...
      child: SingleChildScrollView(
        ...
        child: Form(
          ...
          child: Column(
            children: <Widget>[
              _buildTitleTextField(item),
              SizedBox(height: 30.0),
              _buildDescriptionTextField(item),
              SizedBox(height: 30.0),
              _buildPriceTextField(item),
              SizedBox(height: 30.0),
              _buildLocationAddressTextField(item),
              SizedBox(height: 30.0),
  ...
  void _submitForm(Function updateProduct, Function updateAccommodation,
      Function updateJob, Function updateEvent, Function setSelectedItem,
      [int selectedItemIndex]) {
    // [] optional argument, Function updateItem
...
//    }
    ...
    updateProduct(
      ...
      (bool success) {
        // navigate to the accommodations page only when successful
        if (success) {
          // if success is true
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => MyApp()),
          ).then((_) => setSelectedItem(null));
        } else {
    ...
    return ScopedModelDescendant<MainModel>(
      builder: (BuildContext context, Widget child, MainModel model) {
        ...
        Item selectedItem() {
          ...
          return allItems.firstWhere((Item item) {
            return item.id == model.selectedItemId;
          });
        }
        //...................................
        ...
        return Scaffold(
          ...
          body: _buildPageContent(context, selectedItem()),
        );
      },
    );
  }
